...
def clean_text(text):
    # Remove excessive spaces, new lines, and formatting
    text = re.sub(r'\s+', ' ', text)  # Replace multiple spaces/newlines with single space
    text = re.sub(r'\n+', ' ', text)  # Remove excessive line breaks
    text = re.sub(r'\t+', ' ', text)  # Remove tabs
    text = text.strip()
    
    # Remove code-related content and programming terms
    programming_keywords = [
        "JavaScript", "Python", "C++", "Java", "HTML", "CSS", "React", "Django", "Flask", "Node.js"
    ]
